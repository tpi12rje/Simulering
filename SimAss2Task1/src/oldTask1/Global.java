public class Global {
	public static final int AWAKE = 1, RECEIVE = 2, RESEND = 3;
	...
	public static final int LB = 50;	// Choose the lower bound
	public static final int UB = 500;	// Choose the upper bound 
